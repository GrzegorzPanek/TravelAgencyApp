    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="hero-title mb-4">Jestem Konrad Radzik!</h1>
          <p class="hero-subtitle"><span class="typed" data-typed-items="Wojownik, Magik, Specjalista, Kurwa mistrz"></span></p>
