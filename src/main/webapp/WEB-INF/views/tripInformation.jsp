            ...
            <section id="work" class="portfolio-mf sect-pt4 route information__trip">
                ...
                <div class="row trip-element">
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-sm-5">
                                <a href='<c:url value="/resources/assets/img/work-1.jpg"/>' class="portfolio-lightbox">
                                    <div class="work-img">
                            ...
                            <div class="col-sm-5 hotel-picture" >
                                <a href='<c:url value="/resources/assets/img/work-1.jpg"/>' data-gallery="portfolioGallery" class="portfolio-lightbox">
                                    <div class="work-img">
                                        <img src='<c:url value="/resources/assets/img/hotel.jpg"/>' width="1000"  alt="" class="img-fluid">
